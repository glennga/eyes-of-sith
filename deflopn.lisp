...
(new-location ^meeting@room
	      (concat-strings (list
			       "You have interrupted the Dark Council meeting! The closest Dark Lord, Darth~%"
			       "Thanton, force chokes you as your world fades to black.~%~%Try again!~%")))
(new-location ^mysterious@room
	      (concat-strings (list
			       ...
			       "with your skin disintegrating around it.~%~%Try again!~%")))
...
(new-npc-name ^a@dead@person a-dead-person)
(new-npc-name ^darth@imperius darth-imperius)
...
;;; load all NPCs
(new-npc ^a@dead@person
	 "You are talking to a dead person! Select someone else!~%")
(new-npc ^darth@imperius
...
(new-npc-action ^darth@imperius b
...
(new-npc-action ^jedi@3 b
		"I am no ordinary sith. *push saber through her chest*.~%")
...
(new-npc-location ^darth@imperius ^dark@councils@chambers)
...
(new-object ^darth@nox@hand ^darth@nox)
